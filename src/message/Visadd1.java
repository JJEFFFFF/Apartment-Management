...
public class Visadd1 extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet 
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try
		 {
       //将获得的信息装入数据库
			PreparedStatement s=con.prepareStatement("insert into vismessage values(?,?,?,?,?,?,?)");
			s.setString(1,nu);
			s.setString(2,da);
			s.setString(3,na);	
			s.setString(4,t1);
